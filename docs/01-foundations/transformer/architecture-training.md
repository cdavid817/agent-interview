...
<a id="trans-048"></a>
### TRANS-048 · Pre-Norm、Post-Norm 和 Sandwich Norm 有什么区别？为什么深层模型常用 Pre-Norm？（高级）

> 稳定 ID：`TRANS-048`｜原题号：48
...
<a id="trans-049"></a>
### TRANS-049 · RMSNorm 与 LayerNorm 有什么区别，为什么很多大模型选择 RMSNorm？（高级）

> 稳定 ID：`TRANS-049`｜原题号：49
...
<a id="trans-050"></a>
### TRANS-050 · Transformer 中 FFN/MLP 层承担什么作用？SwiGLU 为什么常见？（高级）

> 稳定 ID：`TRANS-050`｜原题号：50
...
<a id="trans-060"></a>
### TRANS-060 · Transformer 训练出现 Loss Spike、梯度爆炸或 NaN，如何系统定位？（高级）

> 稳定 ID：`TRANS-060`｜原题号：60
