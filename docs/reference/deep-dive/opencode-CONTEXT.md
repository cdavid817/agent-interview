...
> **资料性质：官方一手。** 本文是 OpenCode 仓库根目录 `CONTEXT.md` 的逐字副本，由项目自己维护，MIT 协议（Copyright (c) 2025 opencode）。与同目录下两份非官方分析资料性质不同。
> 收录日期：2026-08-20｜上游：https://github.com/sst/opencode ｜对应题库章节：[OpenCode](../../04-products/opencode/README.md)
> 该文档随仓库演进，引用前请核对上游是否已更新。
